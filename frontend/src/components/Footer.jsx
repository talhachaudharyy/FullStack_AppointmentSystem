...
const Footer = () => {
  ...
  return (
    <>
      <footer className="relative z-10 bg-cover pt-20 pb-10 sm:items-center sm:justify-center lg:pt-[120px] lg:pb-20" style={footerStyle}>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <div className="flex items-center mb-6">
                  <a
                    href="/#"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5]  hover:border-primary hover:bg-primary hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width={8}
                      height={16}
...
const LinkGroup = ({ children, header }) => {
  return (
    <>
      <div className="w-full px-4 sm:w-1/2 sm:justify-center lg:w-2/12">
        <div className="w-full mb-10">
  ...
  return (
    <div>
      <li>
        <a
          href={link}
          className={`inline-block mb-2 text-base leading-loose text-body-color hover:text-gray-300`}
        >
          {label}
        </a>
      </li>
